        ...
        <footer class="footer">
            <div class="container bottom_border">
                <div class="row">
                    <div class=" col-sm-4 col-md col-sm-4  col-12 col">
                        ...
                        <p>
                            <i class="fa fa-location-arrow"></i> 9878/25 sec 9
                            rohini 35
                        </p>
                    ...
                    <div class=" col-sm-4 col-md  col-12 col">
                        ...
                        <ul class="footer_ul2_amrc">
                            <li>
                                <a href="#"
                                    ><i
                                        class="fab fa-twitter fleft padding-right"
                                    ></i>
                                </a>
                                <p>
            ...
            <div class="container">
                ...
                <p class="text-center">
                    ...
                    <a target="_BLANK" href="">GreenboxGPS</a>
                </p>
            </div>
        </footer>
    </div>
